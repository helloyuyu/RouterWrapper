...
import com.helloyuyu.routerwrapper.compiler.feature.transformers.ArrayListTypeTransformImpl;
import com.helloyuyu.routerwrapper.compiler.feature.transformers.ArrayTypeTransformImpl;
import com.helloyuyu.routerwrapper.compiler.feature.transformers.BoxPrimitiveTypeTransformImp;
import com.helloyuyu.routerwrapper.compiler.feature.transformers.ParcelableTypeTransformImpl;
import com.helloyuyu.routerwrapper.compiler.feature.transformers.PrimitiveTypeTransformImpl;
import com.helloyuyu.routerwrapper.compiler.feature.transformers.SerializableTypeTransformImpl;
import com.helloyuyu.routerwrapper.compiler.feature.transformers.StringTypeTransformImpl;
...
public class TypeTransformer {
    ...
    private void init() {
        ...
        typeTransformSet.add(new ParcelableTypeTransformImpl(typeUtils,elements));
